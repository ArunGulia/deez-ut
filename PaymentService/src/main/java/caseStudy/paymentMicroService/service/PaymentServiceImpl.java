...
public class PaymentServiceImpl implements PaymentService {
	...
	public void sendEmail(PaymentDetails payment) throws AddressException {
		final Email email = DefaultEmail.builder().from(new InternetAddress("arungulia1999@gmail.com"))
				.replyTo(new InternetAddress("arungulia1999@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("arungulia1999@gmail.com")))
